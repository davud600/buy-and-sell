            ...
            <form>
              <div className="flex flex-row items-center justify-center lg:justify-start">
                ...
                <button
                  ...
                  className="inline-block p-3 mx-1 text-xs font-medium leading-tight text-white uppercase transition duration-150 ease-in-out bg-gray-700 rounded-full shadow-md hover:bg-gray-800 hover:shadow-lg focus:bg-gray-800 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-gray-900 active:shadow-lg">
                  <svg
